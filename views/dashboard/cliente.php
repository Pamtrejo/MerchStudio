...
<div class="container">
    ...
    <a href="../../core/reportes/comprasCliente1.php" target="_blank" class="btn btn-dark pink">Reporte1</a>
    <a href="../../core/reportes/ventaCliente1.php" target="_blank" class="btn btn-dark pink">Reporte2</a>
    <br>
    <br>
...
<form id="form-cliente" method="post">
        <div class="row">
          <div class="col-sm-6 offset-sm-3">
            <select class="select" id="cliente" value="">
                  </select>

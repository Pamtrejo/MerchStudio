...
<div class="modal fade" id="Modal4" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
                    <button type="button" onclick="reporteproductosxTalla()" class="btn btn-primary" data-tooltip="form-crear">Abrir reporte</button>
                </div>
                </form>
        </div>
        </div>
    ...
    <div class="modal fade" id="Modal5" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
                    <button type="button" onclick="reporteSucursal()" class="btn btn-primary" data-tooltip="form-crear">Abrir reporte</button>
                </div>
                </form>
        </div>
        </div>
    ...
    <div class="modal fade" id="Modal6" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
                    <button type="button" onclick="ventasxSucursal()" class="btn btn-primary" data-tooltip="form-crear">Abrir reporte</button>
                </div>
                </form>
        </div>
        </div>
    ...
    <div class="modal fade" id="Modal3" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
                    <button type="button" onclick="reportePagos()" class="btn btn-primary" data-tooltip="form-crear">Abrir reporte</button>
                </div>
                </form>
        </div>
        </div>

...
require('../../core/reportes/categorias.php');
require('../../core/models/categorias.php');
//se obtiene la fecha y hora del pais 
ini_set('date.timezone','America/El_Salvador');

//se manda a llamar el modelo a utilizar
$reporte= new Categorias;
...
$pdf->Cell(52,6,'Diseno',1,0,'C',1);
$pdf->Cell(45,6,'Precio',1,0,'C',1);
$pdf->Cell(52,6,'Descripcion',1,0,'C',1);
//salto de 10 lineas
$pdf->Ln(10);
...
$datos = $reporte->reporteCategorias($_GET['categorias']);
...
foreach($datos as $fila)
{
    ...
    $pdf->Cell(52,15,$Diseno,1,0,'C',0);
    $pdf->Cell(45,15,$Precio,1,0,'C',0);
    $pdf->Cell(52,15,$Descripcion,1,0,'C',0);                                

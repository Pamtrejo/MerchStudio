...
require('../../core/reportes/ventasPago.php');
...
//se manda a llamar la clase, en la cual se encuentra el encabezado y pie de pagina del reporte(ventasPago.php)
...
$pdf->Cell(85,6,'Tipo de pago',1,0,'C',1);
...
//la variable 'pago' se obtiene del controlador 'sucursal1' para el uso del combobox
//ventasxpago es la funcion por la cual se crea la consulta a la base de datos, ubicada en los modelos
$datos = $reporte->ventasxPago($_GET['pago']);
...
foreach($datos as $fila)
{
    ...
    $pdf->Cell(85,15,$TipoPago,1,0,'C',0);
